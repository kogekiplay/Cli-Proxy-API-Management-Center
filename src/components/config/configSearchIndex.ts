...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'codexContinuationEnabled',
    sectionId: 'advanced',
    labelKey: L('sections.codex_continuation.enabled'),
    qualifierKey: L('sections.codex_continuation.title'),
    hintKey: L('sections.codex_continuation.enabled_desc'),
    yamlKeys: ['codex', 'continuation', 'enabled'],
    keywords: ['codex', 'continuation', 'responses'],
  },
  {
    fieldId: 'codexContinuationMaxContinue',
    sectionId: 'advanced',
    labelKey: L('sections.codex_continuation.max_continue'),
    qualifierKey: L('sections.codex_continuation.title'),
    yamlKeys: ['codex', 'continuation', 'max-continue'],
    keywords: ['codex', 'continuation'],
  },
  {
    fieldId: 'codexContinuationMinN',
    sectionId: 'advanced',
    labelKey: L('sections.codex_continuation.min_n'),
    qualifierKey: L('sections.codex_continuation.title'),
    yamlKeys: ['codex', 'continuation', 'min-n'],
    keywords: ['codex', 'continuation', 'reasoning tokens'],
  },
  {
    fieldId: 'codexContinuationMaxN',
    sectionId: 'advanced',
    labelKey: L('sections.codex_continuation.max_n'),
    qualifierKey: L('sections.codex_continuation.title'),
    yamlKeys: ['codex', 'continuation', 'max-n'],
    keywords: ['codex', 'continuation', 'reasoning tokens'],
  },
  {
    fieldId: 'codexContinuationTruncationStep',
    sectionId: 'advanced',
    labelKey: L('sections.codex_continuation.truncation_step'),
    qualifierKey: L('sections.codex_continuation.title'),
    yamlKeys: ['codex', 'continuation', 'truncation-step'],
    keywords: ['codex', 'continuation', '518'],
  },
  {
    fieldId: 'codexContinuationMarkerText',
    sectionId: 'advanced',
    labelKey: L('sections.codex_continuation.marker_text'),
    qualifierKey: L('sections.codex_continuation.title'),
    yamlKeys: ['codex', 'continuation', 'marker-text'],
    keywords: ['codex', 'continuation', 'commentary'],
  },
  {
    fieldId: 'codexContinuationForwardMarker',
    sectionId: 'advanced',
    labelKey: L('sections.codex_continuation.forward_marker'),
    qualifierKey: L('sections.codex_continuation.title'),
    yamlKeys: ['codex', 'continuation', 'forward-marker'],
    keywords: ['codex', 'continuation', 'commentary'],
  },
  {
    fieldId: 'codexContinuationForceIncludeEncrypted',
    sectionId: 'advanced',
    labelKey: L('sections.codex_continuation.force_include_encrypted'),
    qualifierKey: L('sections.codex_continuation.title'),
    hintKey: L('sections.codex_continuation.force_include_encrypted_desc'),
    yamlKeys: ['codex', 'continuation', 'force-include-encrypted'],
    keywords: ['codex', 'continuation', 'encrypted_content'],
  },
  {
    fieldId: 'codexContinuationMaxTotalOutputTokens',
    sectionId: 'advanced',
    labelKey: L('sections.codex_continuation.max_total_output_tokens'),
    qualifierKey: L('sections.codex_continuation.title'),
    yamlKeys: ['codex', 'continuation', 'max-total-output-tokens'],
    keywords: ['codex', 'continuation', 'token cap'],
  },
